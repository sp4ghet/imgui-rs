...
// Dear ImGui https://github.com/ocornut/imgui with imgui_internal.h api docking
// branch
...
CIMGUI_API ImVec2 *ImVec2_ImVec2Nil(void) { return IM_NEW(ImVec2)(); }
...
CIMGUI_API ImVec4 *ImVec4_ImVec4Nil(void) { return IM_NEW(ImVec4)(); }
...
CIMGUI_API bool igBeginChildStr(const char *str_id, const ImVec2 size,
                                bool border, ImGuiWindowFlags flags) {
  return ImGui::BeginChild(str_id, size, border, flags);
}
CIMGUI_API bool igBeginChildID(ImGuiID id, const ImVec2 size, bool border,
                               ImGuiWindowFlags flags) {
...
CIMGUI_API float igGetWindowDpiScale() { return ImGui::GetWindowDpiScale(); }
...
CIMGUI_API void igSetWindowFocusNil() { return ImGui::SetWindowFocus(); }
CIMGUI_API void igSetWindowFontScale(float scale) {
  return ImGui::SetWindowFontScale(scale);
}
CIMGUI_API void igSetWindowPosStr(const char *name, const ImVec2 pos,
                                  ImGuiCond cond) {
  return ImGui::SetWindowPos(name, pos, cond);
}
CIMGUI_API void igSetWindowSizeStr(const char *name, const ImVec2 size,
                                   ImGuiCond cond) {
  return ImGui::SetWindowSize(name, size, cond);
}
CIMGUI_API void igSetWindowCollapsedStr(const char *name, bool collapsed,
                                        ImGuiCond cond) {
...
CIMGUI_API ImU32 igGetColorU32U32(ImU32 col) { return ImGui::GetColorU32(col); }
...
CIMGUI_API void igPushIDStrStr(const char *str_id_begin,
...
CIMGUI_API void igPushIDInt(int int_id) { return ImGui::PushID(int_id); }
CIMGUI_API void igPopID() { return ImGui::PopID(); }
CIMGUI_API ImGuiID igGetIDStr(const char *str_id) {
  return ImGui::GetID(str_id);
}
CIMGUI_API ImGuiID igGetIDStrStr(const char *str_id_begin,
                                 const char *str_id_end) {
...
CIMGUI_API bool igCheckboxFlagsIntPtr(const char *label, int *flags,
                                      int flags_value) {
  return ImGui::CheckboxFlags(label, flags, flags_value);
}
CIMGUI_API bool igCheckboxFlagsUintPtr(const char *label, unsigned int *flags,
...
CIMGUI_API bool igComboStr_arr(const char *label, int *current_item,
...
CIMGUI_API bool igTreeNodeVStr(const char *str_id, const char *fmt,
                               va_list args) {
  return ImGui::TreeNodeV(str_id, fmt, args);
}
CIMGUI_API bool igTreeNodeVPtr(const void *ptr_id, const char *fmt,
                               va_list args) {
...
CIMGUI_API bool igTreeNodeExStrStr(const char *str_id, ImGuiTreeNodeFlags flags,
                                   const char *fmt, ...) {
  va_list args;
  va_start(args, fmt);
...
CIMGUI_API bool igTreeNodeExPtr(const void *ptr_id, ImGuiTreeNodeFlags flags,
                                const char *fmt, ...) {
  va_list args;
  va_start(args, fmt);
...
CIMGUI_API bool igTreeNodeExVStr(const char *str_id, ImGuiTreeNodeFlags flags,
                                 const char *fmt, va_list args) {
  return ImGui::TreeNodeExV(str_id, flags, fmt, args);
}
CIMGUI_API bool igTreeNodeExVPtr(const void *ptr_id, ImGuiTreeNodeFlags flags,
                                 const char *fmt, va_list args) {
...
CIMGUI_API bool igCollapsingHeaderTreeNodeFlags(const char *label,
                                                ImGuiTreeNodeFlags flags) {
  return ImGui::CollapsingHeader(label, flags);
}
CIMGUI_API bool igCollapsingHeaderBoolPtr(const char *label, bool *p_visible,
                                          ImGuiTreeNodeFlags flags) {
...
CIMGUI_API bool igSelectableBool(const char *label, bool selected,
                                 ImGuiSelectableFlags flags,
                                 const ImVec2 size) {
  return ImGui::Selectable(label, selected, flags, size);
}
CIMGUI_API bool igSelectableBoolPtr(const char *label, bool *p_selected,
                                    ImGuiSelectableFlags flags,
                                    const ImVec2 size) {
...
CIMGUI_API bool igListBoxStr_arr(const char *label, int *current_item,
                                 const char *const items[], int items_count,
                                 int height_in_items) {
...
CIMGUI_API void igPlotLinesFloatPtr(const char *label, const float *values,
...
CIMGUI_API void igPlotHistogramFloatPtr(const char *label, const float *values,
                                        int values_count, int values_offset,
...
CIMGUI_API void igPlotHistogramFnFloatPtr(
    const char *label, float (*values_getter)(void *data, int idx), void *data,
    int values_count, int values_offset, const char *overlay_text,
    float scale_min, float scale_max, ImVec2 graph_size) {
...
CIMGUI_API void igValueFloat(const char *prefix, float v,
...
CIMGUI_API bool igMenuItemBool(const char *label, const char *shortcut,
                               bool selected, bool enabled) {
  return ImGui::MenuItem(label, shortcut, selected, enabled);
}
CIMGUI_API bool igMenuItemBoolPtr(const char *label, const char *shortcut,
...
CIMGUI_API void igDockSpace(ImGuiID id, const ImVec2 size,
                            ImGuiDockNodeFlags flags,
                            const ImGuiWindowClass *window_class) {
  return ImGui::DockSpace(id, size, flags, window_class);
}
CIMGUI_API ImGuiID
igDockSpaceOverViewport(const ImGuiViewport *viewport, ImGuiDockNodeFlags flags,
                        const ImGuiWindowClass *window_class) {
...
CIMGUI_API ImGuiID igGetWindowDockID() { return ImGui::GetWindowDockID(); }
CIMGUI_API bool igIsWindowDocked() { return ImGui::IsWindowDocked(); }
...
CIMGUI_API bool igIsRectVisibleVec2(const ImVec2 rect_min,
...
igGetBackgroundDrawListViewportPtr(ImGuiViewport *viewport) {
  return ImGui::GetBackgroundDrawList(viewport);
}
CIMGUI_API ImDrawList *
igGetForegroundDrawListViewportPtr(ImGuiViewport *viewport) {
...
CIMGUI_API void igCalcListClipping(int items_count, float items_height,
  ...
  return ImGui::CalcListClipping(items_count, items_height,
...
CIMGUI_API int igGetKeyPressedAmount(int key_index, float repeat_delay,
                                     float rate) {
...
CIMGUI_API ImGuiTextRange *ImGuiTextRange_ImGuiTextRangeStr(const char *_b,
                                                            const char *_e) {
...
CIMGUI_API ImGuiStoragePair *ImGuiStoragePair_ImGuiStoragePairInt(ImGuiID _key,
                                                                  int _val_i) {
...
ImGuiStoragePair_ImGuiStoragePairFloat(ImGuiID _key, float _val_f) {
  return IM_NEW(ImGuiStoragePair)(_key, _val_f);
}
CIMGUI_API ImGuiStoragePair *
ImGuiStoragePair_ImGuiStoragePairPtr(ImGuiID _key, void *_val_p) {
...
CIMGUI_API ImColor *ImColor_ImColorNil(void) { return IM_NEW(ImColor)(); }
...
CIMGUI_API void ImDrawList_AddTextVec2(ImDrawList *self, const ImVec2 pos,
                                       ImU32 col, const char *text_begin,
                                       const char *text_end) {
  return self->AddText(pos, col, text_begin, text_end);
}
CIMGUI_API void ImDrawList_AddTextFontPtr(ImDrawList *self, const ImFont *font,
...
CIMGUI_API bool igImIsPowerOfTwoInt(int v) { return ImIsPowerOfTwo(v); }
CIMGUI_API bool igImIsPowerOfTwoU64(ImU64 v) { return ImIsPowerOfTwo(v); }
...
CIMGUI_API int igImTextStrToUtf8(char *buf, int buf_size,
...
CIMGUI_API int igImTextStrFromUtf8(ImWchar *buf, int buf_size,
...
CIMGUI_API float igImPowFloat(float x, float y) { return ImPow(x, y); }
CIMGUI_API double igImPowdouble(double x, double y) { return ImPow(x, y); }
CIMGUI_API float igImLogFloat(float x) { return ImLog(x); }
CIMGUI_API double igImLogdouble(double x) { return ImLog(x); }
CIMGUI_API float igImAbsFloat(float x) { return ImAbs(x); }
CIMGUI_API double igImAbsdouble(double x) { return ImAbs(x); }
CIMGUI_API float igImSignFloat(float x) { return ImSign(x); }
CIMGUI_API double igImSigndouble(double x) { return ImSign(x); }
...
CIMGUI_API void igImLerpVec2Float(ImVec2 *pOut, const ImVec2 a, const ImVec2 b,
                                  float t) {
  *pOut = ImLerp(a, b, t);
}
CIMGUI_API void igImLerpVec2Vec2(ImVec2 *pOut, const ImVec2 a, const ImVec2 b,
                                 const ImVec2 t) {
  *pOut = ImLerp(a, b, t);
}
CIMGUI_API void igImLerpVec4(ImVec4 *pOut, const ImVec4 a, const ImVec4 b,
                             float t) {
  *pOut = ImLerp(a, b, t);
}
...
CIMGUI_API float igImFloorFloat(float f) { return ImFloor(f); }
...
CIMGUI_API ImVec1 *ImVec1_ImVec1Nil(void) { return IM_NEW(ImVec1)(); }
CIMGUI_API void ImVec1_destroy(ImVec1 *self) { IM_DELETE(self); }
CIMGUI_API ImVec1 *ImVec1_ImVec1Float(float _x) { return IM_NEW(ImVec1)(_x); }
CIMGUI_API ImVec2ih *ImVec2ih_ImVec2ihNil(void) { return IM_NEW(ImVec2ih)(); }
...
CIMGUI_API ImRect *ImRect_ImRectNil(void) { return IM_NEW(ImRect)(); }
...
CIMGUI_API ImGuiStyleMod *ImGuiStyleMod_ImGuiStyleModInt(ImGuiStyleVar idx,
                                                         int v) {
  return IM_NEW(ImGuiStyleMod)(idx, v);
}
CIMGUI_API void ImGuiStyleMod_destroy(ImGuiStyleMod *self) { IM_DELETE(self); }
CIMGUI_API ImGuiStyleMod *ImGuiStyleMod_ImGuiStyleModFloat(ImGuiStyleVar idx,
                                                           float v) {
  return IM_NEW(ImGuiStyleMod)(idx, v);
}
CIMGUI_API ImGuiStyleMod *ImGuiStyleMod_ImGuiStyleModVec2(ImGuiStyleVar idx,
                                                          ImVec2 v) {
  return IM_NEW(ImGuiStyleMod)(idx, v);
}
...
CIMGUI_API void ImGuiMenuColumns_Update(ImGuiMenuColumns *self, int count,
                                        float spacing, bool clear) {
  return self->Update(count, spacing, clear);
}
CIMGUI_API float ImGuiMenuColumns_DeclColumns(ImGuiMenuColumns *self, float w0,
                                              float w1, float w2) {
  return self->DeclColumns(w0, w1, w2);
}
CIMGUI_API float ImGuiMenuColumns_CalcExtraSpace(ImGuiMenuColumns *self,
                                                 float avail_w) {
...
CIMGUI_API void ImGuiDockNode_destroy(ImGuiDockNode *self) { IM_DELETE(self); }
...
CIMGUI_API ImGuiDockNodeFlags
ImGuiDockNode_GetMergedFlags(ImGuiDockNode *self) {
...
CIMGUI_API ImGuiID ImGuiWindow_GetIDNoKeepAliveStr(ImGuiWindow *self,
                                                   const char *str,
                                                   const char *str_end) {
  return self->GetIDNoKeepAlive(str, str_end);
}
CIMGUI_API ImGuiID ImGuiWindow_GetIDNoKeepAlivePtr(ImGuiWindow *self,
                                                   const void *ptr) {
...
CIMGUI_API ImGuiLastItemDataBackup *
ImGuiLastItemDataBackup_ImGuiLastItemDataBackup(void) {
...
CIMGUI_API void igGetWindowAllowedExtentRect(ImRect *pOut,
                                             ImGuiWindow *window) {
  *pOut = ImGui::GetWindowAllowedExtentRect(window);
}
CIMGUI_API void igSetWindowPosWindowPtr(ImGuiWindow *window, const ImVec2 pos,
                                        ImGuiCond cond) {
  return ImGui::SetWindowPos(window, pos, cond);
}
CIMGUI_API void igSetWindowSizeWindowPtr(ImGuiWindow *window, const ImVec2 size,
                                         ImGuiCond cond) {
  return ImGui::SetWindowSize(window, size, cond);
}
CIMGUI_API void igSetWindowCollapsedWindowPtr(ImGuiWindow *window,
...
CIMGUI_API void igStartMouseMovingWindowOrNode(ImGuiWindow *window,
  ...
  return ImGui::StartMouseMovingWindowOrNode(window, node,
                                             undock_floating_node);
}
...
CIMGUI_API ImGuiItemFlags igGetItemsFlags() { return ImGui::GetItemsFlags(); }
...
CIMGUI_API void igSetLastItemData(ImGuiWindow *window, ImGuiID item_id,
...
CIMGUI_API void igBeginTooltipEx(ImGuiWindowFlags extra_flags,
...
CIMGUI_API void igDockContextClearNodes(ImGuiContext *ctx, ImGuiID root_id,
...
CIMGUI_API void igDockContextQueueDock(ImGuiContext *ctx, ImGuiWindow *target,
...
CIMGUI_API bool igDockContextCalcDropPosForDocking(
  ...
  return ImGui::DockContextCalcDropPosForDocking(
      target, target_node, payload, split_dir, split_outer, out_pos);
}
...
CIMGUI_API void igSetWindowDock(ImGuiWindow *window, ImGuiID dock_id,
                                ImGuiCond cond) {
...
CIMGUI_API ImGuiID igDockBuilderSplitNode(ImGuiID node_id, ImGuiDir split_dir,
...
CIMGUI_API void
igDockBuilderCopyDockSpace(ImGuiID src_dockspace_id, ImGuiID dst_dockspace_id,
...
CIMGUI_API void igDockBuilderCopyNode(ImGuiID src_node_id, ImGuiID dst_node_id,
...
CIMGUI_API const char *igTableGetColumnNameTablePtr(const ImGuiTable *table,
                                                    int column_n) {
...
igTabBarFindMostRecentlySelectedTabForActiveWindow(ImGuiTabBar *tab_bar) {
...
CIMGUI_API void igRenderArrowDockMenu(ImDrawList *draw_list, ImVec2 p_min,
                                      float sz, ImU32 col) {
...
CIMGUI_API bool igCheckboxFlagsS64Ptr(const char *label, ImS64 *flags,
                                      ImS64 flags_value) {
  return ImGui::CheckboxFlags(label, flags, flags_value);
}
CIMGUI_API bool igCheckboxFlagsU64Ptr(const char *label, ImU64 *flags,
                                      ImU64 flags_value) {
  return ImGui::CheckboxFlags(label, flags, flags_value);
}
...
CIMGUI_API bool igDataTypeApplyOpFromText(const char *buf,
                                          const char *initial_value_buf,
                                          ImGuiDataType data_type, void *p_data,
                                          const char *format) {
  return ImGui::DataTypeApplyOpFromText(buf, initial_value_buf, data_type,
                                        p_data, format);
}
